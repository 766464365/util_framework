 ...
 * @author xw 2018/6/7
 */
public abstract class AbstractConfirmPopup<V extends View> extends AbstractBasicPopup<View> {
    ...
    public AbstractConfirmPopup(Activity activity) {
        super(activity);
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            lineView.setLayoutParams(new LinearLayout.LayoutParams(MATCH_PARENT,
                topLineHeightPixels));
    ...
    protected View makeHeaderView() {
        ...
        cancelButton.setVisibility(cancelVisible ? View.VISIBLE : View.GONE);
        RelativeLayout.LayoutParams cancelParams = new RelativeLayout.LayoutParams(WRAP_CONTENT,
            MATCH_PARENT);
        ...
        RelativeLayout.LayoutParams submitParams = new RelativeLayout.LayoutParams(WRAP_CONTENT,
            MATCH_PARENT);

...
import com.xuwei.framework.popuppicker.popup.AbstractConfirmPopup;
 ...
 * @author xw 2018/6/7
 */
public abstract class AbstractWheelPicker extends AbstractConfirmPopup<View> {
    ...
    public AbstractWheelPicker(Activity activity) {
        super(activity);
    }
